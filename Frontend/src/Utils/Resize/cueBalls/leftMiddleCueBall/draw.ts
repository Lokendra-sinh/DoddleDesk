...
export function drawLeftMiddleCueBall(left: number, top: number, width: string, height: string, canvasRef: React.RefObject<HTMLCanvasElement>) {
  let leftMiddleCueBall = document.querySelector('.left-middle-cue-ball') as HTMLDivElement;
  ...
  leftMiddleCueBall.className = "left-middle-cue-ball";
