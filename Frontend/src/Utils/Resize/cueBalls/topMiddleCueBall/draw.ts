...
export function drawTopMiddleCueBall(left: number, top: number, width: string, height: string, canvasRef: React.RefObject<HTMLCanvasElement>) {
  let topMiddleCueBall = document.querySelector('.top-middle-cue-ball') as HTMLDivElement;
  if(!topMiddleCueBall) {
  ...
  topMiddleCueBall.className = "top-middle-cue-ball";
