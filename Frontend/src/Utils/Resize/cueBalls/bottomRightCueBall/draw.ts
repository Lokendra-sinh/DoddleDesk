...
export function drawBottomRightCueBall(
  left: number,
  top: number,
  width: string,
  height: string,
  ...
  let bottomRightCueBall = document.querySelector(
    ".bottom-right-cue-ball"
  ) as HTMLDivElement;
  if (!bottomRightCueBall) {
    ...
    bottomRightCueBall.className = "bottom-right-cue-ball resize-handle";
