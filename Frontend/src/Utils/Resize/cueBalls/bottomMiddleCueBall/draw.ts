...
export function drawBottomMiddleCueBall(
  left: number,
  top: number,
  width: string,
  height: string,
  ...
  let bottomMiddleCueBall = document.querySelector(
    ".bottom-middle-cue-ball"
  ) as HTMLDivElement;
  if (!bottomMiddleCueBall) {
    ...
    bottomMiddleCueBall.className = "bottom-middle-cue-ball resize-handle";
