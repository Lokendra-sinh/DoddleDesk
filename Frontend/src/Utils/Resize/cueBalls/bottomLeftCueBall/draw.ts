...
export function drawBottomLeftCueBall(left: number, top: number, width: string, height: string, canvasRef: React.RefObject<HTMLCanvasElement>) {
  let bottomLeftCueBall = document.querySelector('.bottom-left-cue-ball') as HTMLDivElement;
  ...
  bottomLeftCueBall.className = "bottom-left-cue-ball";
