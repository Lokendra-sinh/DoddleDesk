...
export function drawRightMiddleCueBall(left: number, top: number, width: string, height: string, canvasRef: React.RefObject<HTMLCanvasElement>) {
  let rightMiddleCueBall = document.querySelector('.right-middle-cue-ball') as HTMLDivElement;
  ...
  rightMiddleCueBall.className = "right-middle-cue-ball";
